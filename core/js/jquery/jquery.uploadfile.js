    ...
    $.fn.uploadFile = function (options) {
        ...
        function setDragDropHandlers(obj, s, ddObj) {
            ddObj.on('dragenter', function (e) {
                e.stopPropagation();
                e.preventDefault();
                $(this).css('border', '2px solid #adce5b');
            });
            ...
            ddObj.on('drop', function (e) {
                $(this).css('border', '2px dotted #adce5b');
                e.preventDefault();
                obj.errorLog.html("");
            ...
            $(document).on('dragover', function (e) {
                e.stopPropagation();
                e.preventDefault();
                ddObj.css('border', '2px dotted #adce5b');
            });
                ...
                if (s.maxFileSize != -1 && files[i].size > s.maxFileSize) {
                    if (s.showError) {
                        $.fancybox({
                            ...
                            'type': 'ajax',
                                  'href': '?controle=Produto&acao=ErroArquivoPeso&file_type='
