...
if (typeof devem.admin.login == 'undefined') { devem.admin.login = new Object(); }
...
devem.admin.login = {
    ...
    validaLogin: function(){
        ...
        $.post(devem.core.defaults.url("admin/login/validar"), $("#form_login").serialize(), function(data){
...
$(document).ready(devem.admin.login.register);