...
if (typeof devem.atividade == 'undefined') { devem.atividade = new Object(); }
...
devem.atividade = {
    ...
    init: function(){
      ...
      if(devem.core.verificadorpagina.validaGetVar('acao', 'consulta')){
        devem.atividade.initConsulta();
        devem.atividade.initConsulta2();
      }
    ...
    initConsulta: function(){
      ...
      $(document).on( 'click', '#drillDownDataTablepedido td.control', function () {
        ...
        if ( i === -1 ) {
          ...
          var nDetailsRow = oTable03.fnOpen( nTr, devem.atividade.fnFormatDetails(oTable03, nTr), 'details' );
      ...
      var sOut =
        '<div class="innerDetails">'+
          '<table cellpadding="5" cellspacing="0" border="0" style="padding-left:50px;">'+
            ...
            '<tr><td>Total de Produtos:</td><td>'+oData.post_id+'</td></tr>'+
    ...
    initConsulta2: function(){
      ...
      $(document).on( 'click', '#drillDownDataTablepedido2 td.control', function () {
        ...
        if ( i === -1 ) {
          $('i', this).removeClass().addClass('fa fa-minus');
          $(this).parent().addClass('drilled');
          var nDetailsRow = oTable032.fnOpen( nTr, devem.atividade.fnFormatDetails2(oTable032, nTr), 'details' );
          $('div.innerDetails', nDetailsRow).slideDown();
          anOpen.push( nTr );
        }
        else {
...
$(document).ready(devem.atividade.register);