...
if (typeof devem.admin == 'undefined') { devem.admin = new Object(); }

//# Cria objeto terciário relacionado à classe quando não existir
if (typeof devem.admin.defaulta == 'undefined') { devem.admin.defaulta = new Object(); }

//# Decladração das funções dentro do objeto criado
devem.admin.defaulta = {

    register: function (){

        devem.admin.defaulta.init();
    ...
    deslogar: function(){
        ...
        $.post(devem.core.defaults.url("admin/login/deslogar"), {}, function(data){
...
$(document).ready(devem.admin.defaulta.register);