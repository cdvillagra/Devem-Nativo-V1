...
final class UiController extends Controller {
    ...
    */
    ...
    public function elementosAction(){
        ...
        $view = new View('layout/elementos.phtml');
    ...
    public function painelAction(){
        ...
        $view = new View('layout/painel.phtml');
    ...
    public function notificacaoAction(){
        ...
        $view = new View('layout/notificacao.phtml');
    ...
    public function iconesAction(){

        $view = new View('layout/icones.phtml');
